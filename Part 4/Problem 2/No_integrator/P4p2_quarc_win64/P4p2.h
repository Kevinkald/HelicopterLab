...
typedef struct {
  real_T radtodeg1[6];                 /* '<S5>/radtodeg1' */
 ...
 * '<S4>'   : 'P4p2/LQR'
 * '<S5>'   : 'P4p2/Plotting'
 * '<S6>'   : 'P4p2/State estimation'
 * '<S7>'   : 'P4p2/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'P4p2/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'P4p2/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'P4p2/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'P4p2/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'P4p2/Heli 3D/Travel rate  rad to deg'
 */
