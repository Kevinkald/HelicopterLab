...
typedef struct {
  ...
  real_T Sum1;                         /* '<S2>/Sum1' */
  real_T Radtodeg[6];                  /* '<S5>/Rad to deg' */
  ...
  real_T Sum2;                         /* '<S2>/Sum2' */
  real_T Sum;                          /* '<S2>/Sum' */
  real_T Radtodeg1[6];                 /* '<S5>/Rad to deg1' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Anglerates_PWORK;                  /* '<S5>/Angle rates' */
...
struct P_P4p2_integral_T_ {
  real_T A_est[36];                    /* Variable: A_est
                                        ...
                                        */
  real_T B_e[12];                      /* Variable: B_e
                                        * Referenced by: '<S6>/B'
                                        */
  real_T C_e[18];                      /* Variable: C_e
  ...
  real_T Traveloffset_Value;           /* Expression: 0
                                        ...
                                        */
  real_T Radtodeg1_Gain;               /* Expression: 180/pi
  ...
  real_T DeadZoney_End;                /* Expression: 0.1
                                        * Referenced by: '<S3>/Dead Zone: y'
                                        */
  real_T Gainy_Gain;                   /* Expression: 10/12
 ...
 * '<S5>'   : 'P4p2_integral/Plotting'
 * '<S6>'   : 'P4p2_integral/State estimation'
 * '<S7>'   : 'P4p2_integral/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'P4p2_integral/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'P4p2_integral/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'P4p2_integral/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'P4p2_integral/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'P4p2_integral/Heli 3D/Travel rate  rad to deg'
 */
