...
void P4p2_integral_output0(void)       /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    P4p2_integral_B.Pitchoffset = P4p2_integral_P.Pitchoffset_Value;
  }
   ...
   */
  P4p2_integral_B.Sum1 = (P4p2_integral_P.PitchTransferFcn_C *
    P4p2_integral_X.PitchTransferFcn_CSTATE + P4p2_integral_P.PitchTransferFcn_D
    * P4p2_integral_B.PitchCounttorad) * P4p2_integral_P.Gain_Gain +
   ...
   */
  for (i = 0; i < 6; i++) {
    P4p2_integral_B.Radtodeg[i] = P4p2_integral_P.Radtodeg_Gain *
   ...
   */
  P4p2_integral_B.Gain = (P4p2_integral_P.ElevationTransferFcn_C *
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
     ...
     *  Gain: '<S7>/Gain'
     */
    P4p2_integral_B.Sum2 = P4p2_integral_P.Gain_Gain_lv *
      P4p2_integral_B.ElevationCounttorad +
     ...
     *  Gain: '<S11>/Gain'
     */
    P4p2_integral_B.Sum = P4p2_integral_P.Gain_Gain_ar *
      P4p2_integral_B.TravelCounttorad + P4p2_integral_P.Traveloffset_Value;
  }
   ...
   */
  for (i = 0; i < 6; i++) {
    P4p2_integral_B.Radtodeg1[i] = P4p2_integral_P.Radtodeg1_Gain *
      P4p2_integral_X.Integrator_CSTATE[i];
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    for (i = 0; i < 6; i++) {
      rtb_TmpSignalConversionAtToFile[i] = P4p2_integral_B.Radtodeg1[i];
    }

    rtb_TmpSignalConversionAtToFile[6] = P4p2_integral_B.Gain_i;
    rtb_TmpSignalConversionAtToFile[7] = P4p2_integral_B.Sum1;
    rtb_TmpSignalConversionAtToFile[8] = P4p2_integral_B.Sum2;
    rtb_TmpSignalConversionAtToFile[9] = P4p2_integral_B.Gain;
    rtb_TmpSignalConversionAtToFile[10] = P4p2_integral_B.Sum;
    rtb_TmpSignalConversionAtToFile[11] = P4p2_integral_B.Gain_d;
    ...
    if (rtmIsMajorTimeStep(P4p2_integral_M)) {
      {
        if (!(++P4p2_integral_DW.ToFile_IWORK.Decimation % 1) &&
            (P4p2_integral_DW.ToFile_IWORK.Count*13)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (((++P4p2_integral_DW.ToFile_IWORK.Count)*13)+1 >= 100000000) {
              (void)fprintf(stdout,
   ...
   *  Gain: '<Root>/C_e'
   */
  tmp[0] = P4p2_integral_B.Gain_i;
  tmp[1] = P4p2_integral_B.Sum1;
  tmp[2] = P4p2_integral_B.Sum2;
  tmp[3] = P4p2_integral_B.Gain;
  tmp[4] = P4p2_integral_B.Sum;
  tmp[5] = P4p2_integral_B.Gain_d;
  for (i = 0; i < 6; i++) {
    tmp_0[i] = P4p2_integral_P.Degtorad_Gain * tmp[i];
  }
  ...
  for (i = 0; i < 3; i++) {
    rtb_C_ex[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_C_ex[i] += P4p2_integral_P.C_e[3 * i_0 + i] * tmp_0[i_0];
    }
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    P4p2_integral_B.Referencefeedforward[0] += P4p2_integral_P.P[0] *
      P4p2_integral_B.Joystick_gain_x;
    P4p2_integral_B.Referencefeedforward[0] += P4p2_integral_P.P[2] *
      P4p2_integral_B.Joystick_gain_y;
    P4p2_integral_B.Referencefeedforward[1] = 0.0;
    P4p2_integral_B.Referencefeedforward[1] += P4p2_integral_P.P[1] *
      P4p2_integral_B.Joystick_gain_x;
    P4p2_integral_B.Referencefeedforward[1] += P4p2_integral_P.P[3] *
      P4p2_integral_B.Joystick_gain_y;
  }
   ...
   *  Integrator: '<S6>/Integrator'
   */
  tmp_1[0] = P4p2_integral_X.Integrator_CSTATE[0];
  tmp_1[1] = P4p2_integral_X.Integrator_CSTATE[1];
  tmp_1[2] = P4p2_integral_X.Integrator_CSTATE[3];
  tmp_1[3] = P4p2_integral_X.Integrator1_CSTATE;
  tmp_1[4] = P4p2_integral_X.Integrator_CSTATE_p;
  ...
  for (i = 0; i < 2; i++) {
    rtb_Frontgain = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Frontgain += P4p2_integral_P.K[(i_0 << 1) + i] * tmp_1[i_0];
    }

    rtb_u[i] = P4p2_integral_B.Referencefeedforward[i] - rtb_Frontgain;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_u[1] + rtb_Frontgain) * P4p2_integral_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Frontgain - rtb_u[1]) * P4p2_integral_P.Backgain_Gain;
   ...
   *  Integrator: '<S6>/Integrator'
   */
  P4p2_integral_B.Sum1_m = P4p2_integral_X.Integrator_CSTATE[0] -
    P4p2_integral_B.Joystick_gain_x;

  /* Sum: '<S4>/Sum2' incorporates:
   *  Integrator: '<S6>/Integrator'
   */
  P4p2_integral_B.Sum2_g = P4p2_integral_X.Integrator_CSTATE[3] -
    P4p2_integral_B.Joystick_gain_y;
  for (i = 0; i < 6; i++) {
    /* Gain: '<S6>/B' incorporates:
     *  Sum: '<S6>/Sum'
     */
    tmp[i] = P4p2_integral_P.B_e[i + 6] * rtb_u[1] + P4p2_integral_P.B_e[i] *
      rtb_u[0];

    /* Gain: '<S6>/L' incorporates:
     *  Sum: '<S6>/Sum'
     */
    tmp_0[i] = P4p2_integral_P.L[i + 12] * rtb_C_ex[2] + (P4p2_integral_P.L[i +
      6] * rtb_C_ex[1] + P4p2_integral_P.L[i] * rtb_C_ex[0]);
  }
  ...
  for (i = 0; i < 6; i++) {
    rtb_Frontgain = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Frontgain += P4p2_integral_P.A_est[6 * i_0 + i] *
        P4p2_integral_X.Integrator_CSTATE[i_0];
    }

    P4p2_integral_B.Sum_c[i] = (tmp[i] + tmp_0[i]) + rtb_Frontgain;
  }
}
...
void P4p2_integral_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator_CSTATE[i] = P4p2_integral_B.Sum_c[i];
  }
  ...
  _rtXdot->Integrator1_CSTATE = P4p2_integral_B.Sum1_m;

  /* Derivatives for Integrator: '<S4>/Integrator' */
  _rtXdot->Integrator_CSTATE_p = P4p2_integral_B.Sum2_g;
}
...
void P4p2_integral_initialize(void)
{
...

  {
    ...
    P4p2_integral_X.Integrator_CSTATE_p = P4p2_integral_P.Integrator_IC_p;
  }
}
...
RT_MODEL_P4p2_integral_T *P4p2_integral(void)
{
...

  {
    int_T i;
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Radtodeg[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Radtodeg1[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Sum_c[i] = 0.0;
    }

    P4p2_integral_B.PitchCounttorad = 0.0;
    P4p2_integral_B.Pitchoffset = 0.0;
    ...
    P4p2_integral_B.Sum1_m = 0.0;
    P4p2_integral_B.Sum2_g = 0.0;
  }
