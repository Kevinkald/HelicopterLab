...
struct P_P4p3_T_ {
  ...
  real_T B_e[12];                      /* Variable: B_e
                                        * Referenced by: '<S6>/B'
                                        */
  real_T C_elambda[12];                /* Variable: C_elambda
                                        * Referenced by: '<Root>/C_pe'
                                        */
 ...
 * '<S4>'   : 'P4p3/LQR'
 * '<S5>'   : 'P4p3/Plotting'
 * '<S6>'   : 'P4p3/State estimation'
 * '<S7>'   : 'P4p3/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'P4p3/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'P4p3/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'P4p3/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'P4p3/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'P4p3/Heli 3D/Travel rate  rad to deg'
 */
