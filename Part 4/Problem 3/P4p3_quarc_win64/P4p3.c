 ...
 * C source code generated on : Sat Oct 20 00:49:41 2018
 *
...
void P4p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
    ...
    P4p3_B.Pitchoffset = P4p3_P.Pitchoffset_Value;
  }
   ...
   */
  P4p3_B.Sum1 = (P4p3_P.PitchTransferFcn_C * P4p3_X.PitchTransferFcn_CSTATE +
                 P4p3_P.PitchTransferFcn_D * P4p3_B.PitchCounttorad) *
    P4p3_P.Gain_Gain + P4p3_B.Pitchoffset;

  /* Gain: '<S5>/Rad to deg' incorporates:
   *  Integrator: '<S6>/Integrator'
   */
  for (i = 0; i < 6; i++) {
    P4p3_B.Radtodeg[i] = P4p3_P.Radtodeg_Gain * P4p3_X.Integrator_CSTATE[i];
  }

  /* End of Gain: '<S5>/Rad to deg' */
  if (rtmIsMajorTimeStep(P4p3_M)) {
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
     ...
     *  Gain: '<S7>/Gain'
     */
    P4p3_B.Sum2 = P4p3_P.Gain_Gain_lv * P4p3_B.ElevationCounttorad +
      P4p3_P.Elevationoffset_Value;

    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<S2>/Travel offset '
     *  Gain: '<S11>/Gain'
     */
    P4p3_B.Sum = P4p3_P.Gain_Gain_ar * P4p3_B.TravelCounttorad +
      P4p3_P.Traveloffset_Value;
  }

  /* Gain: '<S5>/Rad to deg1' incorporates:
   *  Integrator: '<S6>/Integrator'
   */
  for (i = 0; i < 6; i++) {
    P4p3_B.Radtodeg1[i] = P4p3_P.Radtodeg1_Gain * P4p3_X.Integrator_CSTATE[i];
  }

  /* End of Gain: '<S5>/Rad to deg1' */
  if (rtmIsMajorTimeStep(P4p3_M)) {
    /* SignalConversion: '<S5>/TmpSignal ConversionAtTo FileInport1' */
    for (i = 0; i < 6; i++) {
      rtb_TmpSignalConversionAtToFile[i] = P4p3_B.Radtodeg1[i];
    }

    rtb_TmpSignalConversionAtToFile[6] = P4p3_B.Gain_i;
    rtb_TmpSignalConversionAtToFile[7] = P4p3_B.Sum1;
    rtb_TmpSignalConversionAtToFile[8] = P4p3_B.Sum2;
    rtb_TmpSignalConversionAtToFile[9] = P4p3_B.Gain;
    rtb_TmpSignalConversionAtToFile[10] = P4p3_B.Sum;
    rtb_TmpSignalConversionAtToFile[11] = P4p3_B.Gain_d;
    ...
    if (rtmIsMajorTimeStep(P4p3_M)) {
      {
        if (!(++P4p3_DW.ToFile_IWORK.Decimation % 1) &&
            (P4p3_DW.ToFile_IWORK.Count*13)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 13, fp) != 13) {
              rtmSetErrorStatus(P4p3_M, "Error writing to MAT-file FILENAME.mat");
              return;
            }

            if (((++P4p3_DW.ToFile_IWORK.Count)*13)+1 >= 100000000) {
              (void)fprintf(stdout,
  ...
  tmp[5] = P4p3_B.Gain_d;
  for (i = 0; i < 6; i++) {
    tmp_0[i] = P4p3_P.Degtorad_Gain * tmp[i];
  }
  ...
  for (i = 0; i < 2; i++) {
    rtb_C_pe[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_C_pe[i] += P4p3_P.C_elambda[(i_0 << 1) + i] * tmp_0[i_0];
    }
  }
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
     ...
     */
    P4p3_B.Referencefeedforward[0] = 0.0;
    P4p3_B.Referencefeedforward[0] += P4p3_P.P[0] * P4p3_B.Joystick_gain_x;
    P4p3_B.Referencefeedforward[0] += P4p3_P.P[2] * P4p3_B.Joystick_gain_y;
    P4p3_B.Referencefeedforward[1] = 0.0;
    P4p3_B.Referencefeedforward[1] += P4p3_P.P[1] * P4p3_B.Joystick_gain_x;
    P4p3_B.Referencefeedforward[1] += P4p3_P.P[3] * P4p3_B.Joystick_gain_y;
  }
   ...
   *  Integrator: '<S6>/Integrator'
   */
  tmp_1[0] = P4p3_X.Integrator_CSTATE[0];
  tmp_1[1] = P4p3_X.Integrator_CSTATE[1];
  tmp_1[2] = P4p3_X.Integrator_CSTATE[3];
  tmp_1[3] = P4p3_X.Integrator1_CSTATE;
  tmp_1[4] = P4p3_X.Integrator_CSTATE_e;
  ...
  for (i = 0; i < 2; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      u0 += P4p3_P.K[(i_0 << 1) + i] * tmp_1[i_0];
    }

    rtb_u[i] = P4p3_B.Referencefeedforward[i] - u0;
  }
  ...
  if (rtmIsMajorTimeStep(P4p3_M)) {
     ...
     */
    P4p3_B.Sum_l = P4p3_P.v_s_star + P4p3_P.Constant1_Value;
  }
   ...
   *  Sum: '<S1>/Sum1'
   */
  u0 = ((rtb_u[0] + P4p3_B.Sum_l) + rtb_u[1]) * P4p3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (0.0 - rtb_u[1]) * P4p3_P.Backgain_Gain;
   ...
   *  Integrator: '<S6>/Integrator'
   */
  P4p3_B.Sum1_b = P4p3_X.Integrator_CSTATE[0] - P4p3_B.Joystick_gain_x;

  /* Sum: '<S4>/Sum2' incorporates:
   *  Integrator: '<S6>/Integrator'
   */
  P4p3_B.Sum2_g = P4p3_X.Integrator_CSTATE[3] - P4p3_B.Joystick_gain_y;
  for (i = 0; i < 6; i++) {
    /* Gain: '<S6>/B' incorporates:
     *  Sum: '<S6>/Sum'
     */
    tmp[i] = P4p3_P.B_e[i + 6] * rtb_u[1] + P4p3_P.B_e[i] * rtb_u[0];

    /* Gain: '<S6>/L' incorporates:
     *  Sum: '<S6>/Sum'
     */
    tmp_0[i] = P4p3_P.L[i + 6] * rtb_C_pe[1] + P4p3_P.L[i] * rtb_C_pe[0];
  }
  ...
  for (i = 0; i < 6; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      u0 += P4p3_P.A_est[6 * i_0 + i] * P4p3_X.Integrator_CSTATE[i_0];
    }

    P4p3_B.Sum_c[i] = (tmp[i] + tmp_0[i]) + u0;
  }
}
...
void P4p3_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator_CSTATE[i] = P4p3_B.Sum_c[i];
  }
  ...
  _rtXdot->Integrator1_CSTATE = P4p3_B.Sum1_b;

  /* Derivatives for Integrator: '<S4>/Integrator' */
  _rtXdot->Integrator_CSTATE_e = P4p3_B.Sum2_g;
}
...
void P4p3_initialize(void)
{
  ...
  /* Start for ToFile: '<S5>/To File' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p3_M, "Error creating .mat file FILENAME.mat");
      return;
    }
...

  {
    ...
    P4p3_X.Integrator_CSTATE_e = P4p3_P.Integrator_IC_b;
  }
}
...
void P4p3_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S5>/To File' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "FILENAME.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p3_M, "Error closing MAT-file FILENAME.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p3_M, "Error reopening MAT-file FILENAME.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 13, P4p3_DW.ToFile_IWORK.Count, "ans")) {
        rtmSetErrorStatus(P4p3_M,
...
RT_MODEL_P4p3_T *P4p3(void)
{
  ...
  /* External mode info */
  P4p3_M->Sizes.checksums[0] = (4189727773U);
  P4p3_M->Sizes.checksums[1] = (2073956833U);
  P4p3_M->Sizes.checksums[2] = (1512469189U);
  P4p3_M->Sizes.checksums[3] = (1942432472U);
...

  {
    int_T i;
    for (i = 0; i < 6; i++) {
      P4p3_B.Radtodeg[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      P4p3_B.Radtodeg1[i] = 0.0;
    }
  ...
  P4p3_M->Sizes.numBlocks = (70);      /* Number of blocks */
  P4p3_M->Sizes.numBlockIO = (25);     /* Number of block outputs */
  P4p3_M->Sizes.numBlockPrms = (238);  /* Sum of parameter "widths" */
  return P4p3_M;
}
