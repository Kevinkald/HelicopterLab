...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ElevationRate_PWORK;               /* '<S5>/ElevationRate' */
  ...
  struct {
    void *LoggedData;
  } TravelRate_PWORK;                  /* '<S5>/TravelRate' */
...
struct P_heli_q8_T_ {
  ...
  real_T Step3_Y0;                     /* Expression: 0
                                        * Referenced by: '<S7>/Step3'
                                        */
  real_T Step3_YFinal;                 /* Expression: pi/6
                                        * Referenced by: '<S7>/Step3'
                                        */
  real_T Step2_Time;                   /* Expression: 12
                                        * Referenced by: '<S7>/Step2'
                                        */
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<S7>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: pi/6
                                        * Referenced by: '<S7>/Step2'
                                        */
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<S7>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: pi/20
                                        * Referenced by: '<S7>/Step'
                                        */
  real_T Step1_Time;                   /* Expression: 9
                                        * Referenced by: '<S7>/Step1'
                                        */
  real_T Step1_Y0;                     /* Expression: 0
                                        * Referenced by: '<S7>/Step1'
                                        */
  real_T Step1_YFinal;                 /* Expression: pi/20
                                        * Referenced by: '<S7>/Step1'
                                        */
 ...
 * '<S4>'   : 'heli_q8/LQR'
 * '<S5>'   : 'heli_q8/Plotting'
 * '<S6>'   : 'heli_q8/State estimation'
 * '<S7>'   : 'heli_q8/reference '
