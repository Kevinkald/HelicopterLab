...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_L_idx_3;
  real_T rtb_L_idx_4;
  real_T rtb_TmpSignalConversionAtLInp_0;
  real_T rtb_TmpSignalConversionAtLInp_1;
  real_T u0;
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 13, fp) != 13) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile_IWORK.Count)*13)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    allowed in MAT-file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat.\n");
            }
          }
        }
      }
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step3_Time) {
    rtb_Sum1 = heli_q8_P.Step3_Y0;
  } else {
    rtb_Sum1 = heli_q8_P.Step3_YFinal;
  }
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step2_Time) {
    rtb_L_idx_0 = heli_q8_P.Step2_Y0;
  } else {
    rtb_L_idx_0 = heli_q8_P.Step2_YFinal;
  }

  /* End of Step: '<S7>/Step2' */

  /* Sum: '<S7>/Sum' */
  rtb_Sum = rtb_Sum1 - rtb_L_idx_0;

  /* Step: '<S7>/Step' */
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    rtb_Sum1 = heli_q8_P.Step_Y0;
  } else {
    rtb_Sum1 = heli_q8_P.Step_YFinal;
  }
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step1_Time) {
    rtb_L_idx_0 = heli_q8_P.Step1_Y0;
  } else {
    rtb_L_idx_0 = heli_q8_P.Step1_YFinal;
  }

  /* End of Step: '<S7>/Step1' */

  /* Sum: '<S7>/Sum1' */
  rtb_Sum1 -= rtb_L_idx_0;

  /* Gain: '<Root>/degtorad3' */
  rtb_L_idx_0 = heli_q8_P.degtorad3_Gain * heli_q8_B.Gain_i;
  rtb_L_idx_2 = heli_q8_P.degtorad3_Gain * heli_q8_B.Sum2;
  rtb_L_idx_3 = heli_q8_P.degtorad3_Gain * heli_q8_B.Gain;
   ...
   */
  rtb_L_0[0] = rtb_L_idx_0;
  rtb_L_0[1] = heli_q8_P.degtorad3_Gain * heli_q8_B.Sum1;
  rtb_L_0[2] = rtb_L_idx_3;
  rtb_L_0[3] = heli_q8_X.Integrator1_CSTATE;
  rtb_L_0[4] = heli_q8_X.Integrator_CSTATE_c;
  ...
  for (i = 0; i < 2; i++) {
    tmp[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp[i] += heli_q8_P.K[(i_0 << 1) + i] * rtb_L_0[i_0];
    }
  }
   ...
   */
  rtb_TmpSignalConversionAtLInp_0 = (heli_q8_P.P[0] * rtb_Sum + heli_q8_P.P[2] *
    rtb_Sum1) - tmp[0];
  rtb_TmpSignalConversionAtLInp_1 = (heli_q8_P.P[1] * rtb_Sum + heli_q8_P.P[3] *
    rtb_Sum1) - tmp[1];

  /* Sum: '<Root>/Sum' */
  rtb_Backgain = rtb_TmpSignalConversionAtLInp_0 + heli_q8_B.Constant;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_TmpSignalConversionAtLInp_1 + rtb_Backgain) *
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain - rtb_TmpSignalConversionAtLInp_1) *
  ...
  /* Sum: '<S4>/Sum1' */
  heli_q8_B.Sum1_n = rtb_L_idx_0 - rtb_Sum;

  /* Sum: '<S4>/Sum2' */
  heli_q8_B.Sum2_f = rtb_L_idx_3 - rtb_Sum1;
  for (i = 0; i < 6; i++) {
    /* Gain: '<S6>/B' incorporates:
     *  Sum: '<S6>/Sum'
     */
    tmp_0[i] = heli_q8_P.B_e[i + 6] * rtb_TmpSignalConversionAtLInp_1 +
      heli_q8_P.B_e[i] * rtb_TmpSignalConversionAtLInp_0;

    /* Gain: '<S6>/L' incorporates:
     *  SignalConversion: '<S6>/TmpSignal ConversionAtLInport1'
     *  Sum: '<S6>/Sum'
     */
    tmp_1[i] = heli_q8_P.L[i + 6] * rtb_L_idx_4 + heli_q8_P.L[i] * rtb_L_idx_2;
  }
  ...
  for (i = 0; i < 6; i++) {
    rtb_Sum1 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Sum1 += heli_q8_P.A_est[6 * i_0 + i] * heli_q8_X.Integrator_CSTATE[i_0];
    }

    heli_q8_B.Sum_c[i] = (tmp_0[i] + tmp_1[i]) + rtb_Sum1;
  }
...
void heli_q8_initialize(void)
{
  ...
  {
    char fileName[509] =
      "problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,13,0,"estimationvsmeasured")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S5>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 13, heli_q8_DW.ToFile_IWORK.Count,
        ...
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for estimationvsmeasured to MAT-file problem3_reduced_C_to_pitchel_evation_optimized_for_pitch_rate.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2821736815U);
  heli_q8_M->Sizes.checksums[1] = (43082960U);
  heli_q8_M->Sizes.checksums[2] = (4057728705U);
  heli_q8_M->Sizes.checksums[3] = (3686369058U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (236);/* Sum of parameter "widths" */
  return heli_q8_M;
}
