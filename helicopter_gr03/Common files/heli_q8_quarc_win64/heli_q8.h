...
typedef struct {
  ...
  real_T Gain;                         /* '<S9>/Gain' */
  real_T degtorad1;                    /* '<Root>/degtorad1' */
  real_T K_ep1;                        /* '<S5>/K_ep1' */
  real_T K_ei;                         /* '<S6>/K_ei' */
...
typedef struct {
  ...
  real_T TimeStampA_d;                 /* '<Root>/Derivative1' */
  real_T LastUAtTimeA_i;               /* '<Root>/Derivative1' */
  real_T TimeStampB_j;                 /* '<Root>/Derivative1' */
  real_T LastUAtTimeB_i;               /* '<Root>/Derivative1' */
