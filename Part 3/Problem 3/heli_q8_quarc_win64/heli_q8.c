 ...
 * C source code generated on : Wed Oct 17 18:19:31 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  rtb_Degtorad_idx_2 = heli_q8_P.Degtorad_Gain * heli_q8_B.Gain_i;
  rtb_Degtorad_idx_5 = heli_q8_P.Degtorad_Gain * heli_q8_B.Gain_d;

  /* Gain: '<S2>/Pitch' */
  heli_q8_B.Pitch[0] = heli_q8_P.Pitch_Gain * heli_q8_B.Joystick_gain_x;
  heli_q8_B.Pitch[1] = heli_q8_P.Pitch_Gain * rtb_Degtorad_idx_2;
  ...
  heli_q8_B.Elevationrate[0] = heli_q8_P.Elevationrate_Gain *
    heli_q8_B.Joystick_gain_y;
  heli_q8_B.Elevationrate[1] = heli_q8_P.Elevationrate_Gain * rtb_Degtorad_idx_5;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  rtb_Degtorad_0[1] = heli_q8_P.Degtorad_Gain * heli_q8_B.Sum1;
  rtb_Degtorad_0[2] = rtb_Degtorad_idx_5;
  rtb_Degtorad_0[3] = heli_q8_X.Integrator1_CSTATE;
  rtb_Degtorad_0[4] = heli_q8_X.Integrator_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      u0 += heli_q8_P.K[(i_0 << 1) + i] * rtb_Degtorad_0[i_0];
    }

    rtb_u[i] = heli_q8_B.Referencefeedforward[i] - u0;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_u[1] + rtb_u[0]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_u[0] - rtb_u[1]) * heli_q8_P.Backgain_Gain;
  ...
  /* Sum: '<S5>/Sum1' */
  heli_q8_B.Sum1_l = rtb_Degtorad_idx_2 - heli_q8_B.Joystick_gain_x;

  /* Sum: '<S5>/Sum2' */
  heli_q8_B.Sum2_o = rtb_Degtorad_idx_5 - heli_q8_B.Joystick_gain_y;
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (641201740U);
  heli_q8_M->Sizes.checksums[1] = (4206036651U);
  heli_q8_M->Sizes.checksums[2] = (2278604464U);
  heli_q8_M->Sizes.checksums[3] = (2900750203U);
...

  {
    ...
    heli_q8_B.Pitch[0] = 0.0;
    heli_q8_B.Pitch[1] = 0.0;
    heli_q8_B.RateTransitiony = 0.0;
    heli_q8_B.Joystick_gain_y = 0.0;
    heli_q8_B.Elevationrate[0] = 0.0;
    heli_q8_B.Elevationrate[1] = 0.0;
    heli_q8_B.Referencefeedforward[0] = 0.0;
    heli_q8_B.Referencefeedforward[1] = 0.0;
