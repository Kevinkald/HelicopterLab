 ...
 * '<S5>'   : 'heli_q81/LQR'
 * '<S6>'   : 'heli_q81/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'heli_q81/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'heli_q81/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'heli_q81/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'heli_q81/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'heli_q81/Heli 3D/Travel rate  rad to deg'
 */
