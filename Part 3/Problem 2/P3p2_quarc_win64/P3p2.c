 ...
 * C source code generated on : Sun Oct 21 19:34:21 2018
 *
...
void P3p2_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
     ...
     *  Gain: '<S10>/Gain'
     */
    P3p2_B.Sum = P3p2_P.Gain_Gain * P3p2_B.TravelCounttorad +
      P3p2_P.Traveloffset_Value;
  }

  /* Gain: '<S11>/Gain' incorporates:
   *  TransferFcn: '<S3>/Travel: Transfer Fcn'
   */
  P3p2_B.Gain = (P3p2_P.TravelTransferFcn_C * P3p2_X.TravelTransferFcn_CSTATE +
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    ...
    P3p2_B.Pitchoffset = P3p2_P.Pitchoffset_Value;
  }
   ...
   */
  P3p2_B.Sum1 = (P3p2_P.PitchTransferFcn_C * P3p2_X.PitchTransferFcn_CSTATE +
                 P3p2_P.PitchTransferFcn_D * P3p2_B.PitchCounttorad) *
    P3p2_P.Gain_Gain_ae + P3p2_B.Pitchoffset;
  if (rtmIsMajorTimeStep(P3p2_M)) {
     ...
     *  Gain: '<S6>/Gain'
     */
    P3p2_B.Sum2 = P3p2_P.Gain_Gain_lv * P3p2_B.ElevationCounttorad +
      P3p2_P.Elevationoffset_Value;
  }
  ...
  rtb_Degtorad_idx_2 = P3p2_P.Degtorad_Gain * P3p2_B.Gain_i;
  rtb_Degtorad_idx_3 = P3p2_P.Degtorad_Gain * P3p2_B.Sum1;
  rtb_Degtorad_idx_5 = P3p2_P.Degtorad_Gain * P3p2_B.Gain_d;

  /* Gain: '<S2>/Pitch' */
  P3p2_B.Pitch[0] = P3p2_P.Pitch_Gain * P3p2_B.Joystick_gain_x;
  P3p2_B.Pitch[1] = P3p2_P.Pitch_Gain * rtb_Degtorad_idx_2;
  ...
  P3p2_B.Elevationrate[0] = P3p2_P.Elevationrate_Gain * P3p2_B.Joystick_gain_y;
  P3p2_B.Elevationrate[1] = P3p2_P.Elevationrate_Gain * rtb_Degtorad_idx_5;
  if (rtmIsMajorTimeStep(P3p2_M)) {
    /* Gain: '<S5>/Reference feed forward ' incorporates:
     *  SignalConversion: '<S5>/TmpSignal ConversionAtReference feed forward Inport1'
     */
    P3p2_B.Referencefeedforward[0] = 0.0;
    P3p2_B.Referencefeedforward[0] += P3p2_P.P[0] * P3p2_B.Joystick_gain_x;
    P3p2_B.Referencefeedforward[0] += P3p2_P.P[2] * P3p2_B.Joystick_gain_y;
    P3p2_B.Referencefeedforward[1] = 0.0;
    P3p2_B.Referencefeedforward[1] += P3p2_P.P[1] * P3p2_B.Joystick_gain_x;
    P3p2_B.Referencefeedforward[1] += P3p2_P.P[3] * P3p2_B.Joystick_gain_y;
  }
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_u[i] = P3p2_B.Referencefeedforward[i] - ((P3p2_P.K[i + 2] *
      rtb_Degtorad_idx_3 + P3p2_P.K[i] * rtb_Degtorad_idx_2) + P3p2_P.K[i + 4] *
      rtb_Degtorad_idx_5);
  }
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    /* Constant: '<S1>/v_s_+' */
    P3p2_B.v_s_ = P3p2_P.v_s__Value;
  }

  /* Sum: '<S1>/Sum' */
  rtb_Backgain = rtb_u[0] + P3p2_B.v_s_;
  if (rtmIsMajorTimeStep(P3p2_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Degtorad_idx_2 = (rtb_u[1] + rtb_Backgain) * P3p2_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_Degtorad_idx_2 > P3p2_P.FrontmotorSaturation_UpperSat) {
    P3p2_B.FrontmotorSaturation = P3p2_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Degtorad_idx_2 < P3p2_P.FrontmotorSaturation_LowerSat) {
    P3p2_B.FrontmotorSaturation = P3p2_P.FrontmotorSaturation_LowerSat;
  } else {
    P3p2_B.FrontmotorSaturation = rtb_Degtorad_idx_2;
  }
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Degtorad_idx_2 = (rtb_Backgain - rtb_u[1]) * P3p2_P.Backgain_Gain;

  /* Saturate: '<S3>/Back motor: Saturation' */
  if (rtb_Degtorad_idx_2 > P3p2_P.BackmotorSaturation_UpperSat) {
    P3p2_B.BackmotorSaturation = P3p2_P.BackmotorSaturation_UpperSat;
  } else if (rtb_Degtorad_idx_2 < P3p2_P.BackmotorSaturation_LowerSat) {
    P3p2_B.BackmotorSaturation = P3p2_P.BackmotorSaturation_LowerSat;
  } else {
    P3p2_B.BackmotorSaturation = rtb_Degtorad_idx_2;
  }
...
RT_MODEL_P3p2_T *P3p2(void)
{
  ...
  /* External mode info */
  P3p2_M->Sizes.checksums[0] = (2940495208U);
  P3p2_M->Sizes.checksums[1] = (1111944576U);
  P3p2_M->Sizes.checksums[2] = (3332233575U);
  P3p2_M->Sizes.checksums[3] = (87052896U);
...

  {
    ...
    P3p2_B.Elevationrate[0] = 0.0;
    P3p2_B.Elevationrate[1] = 0.0;
    P3p2_B.Referencefeedforward[0] = 0.0;
    P3p2_B.Referencefeedforward[1] = 0.0;
    P3p2_B.v_s_ = 0.0;
  ...
  P3p2_M->Sizes.numBlocks = (55);      /* Number of blocks */
