  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P2p1_B.Elevationrate
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 12;
	
	  ;% P2p1_B.Pitchreference
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 13;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P2p1_DW.Elevationscope_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% P2p1_DW.Pitchscope_PWORK.LoggedData
  ...
  targMap.checksum0 = 3571071013;
  targMap.checksum1 = 1172888010;
  targMap.checksum2 = 2254224467;
  targMap.checksum3 = 1967765320;
